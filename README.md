...
- A "compare multiple startups against one thesis" batch mode.
- PDF export instead of just Markdown, for a more client-deliverable feel.
- A lightweight "critic" node that reviews the assessment against the raw
  research before returning it, flagging any unsupported claims.
